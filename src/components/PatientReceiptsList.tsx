...
export default function PatientReceiptsList({
  receipts,
  treatmentType,
}: {
  ...
  const label = treatmentLabel(treatmentType);
  ...
  return (
    <section style={{ marginTop: 18 }}>
      ...
      <p style={{ fontSize: 12.5, color: "#6B7785", margin: "0 0 10px", lineHeight: 1.45 }}>
        Payment receipts for your {label} treatment. A copy was also emailed to you.
      </p>
